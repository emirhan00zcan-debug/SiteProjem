...
const HeroSection = () => {
    ...
    const slides = [
        {
            bgImage: "url('/assets/images/premium-kitchen-2.png')",
        ...
        {
            bgImage: "url('/assets/images/insaat-proje.png')",
        ...
        {
            bgImage: "url('/assets/images/ev-yenileme-kampanya.png')",
            tag: "FIRSATI KAÇIRMA",
        ...
        {
            bgImage: "url('/assets/images/t1_pro_1769533091788.png')",
        ...
        {
            bgImage: "url('/assets/images/pro-mutfak-3.png')",
            tag: "GURME MUTFAKLAR",
            title: "Hayalinizdeki \n Mutfak",
        ...
        {
            bgImage: "url('/assets/images/premium-bedroom.png')",
            tag: "HUZURLU UYKU",
        ...
        {
            bgImage: "url('/assets/images/premium-bathroom.png')",
            tag: "MODERN BANYO",
            title: "Ferah ve Şık \n Banyo Çözümleri",
        ...
        {
            bgImage: "url('/assets/images/d4_pro_1769532928933.png')",
            tag: "İLK İZLENİM",
        ...
        {
            bgImage: "url('/assets/images/d6_pro_1769532959772.png')",
            tag: "ŞIK DETAYLAR",
            title: "Evinizin \n Giriş İmzası",
